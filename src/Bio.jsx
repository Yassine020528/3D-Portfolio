  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px' }}>
        ...
        <button onClick={() => { onClose(); playSound(); }}
        style={{ background: 'none', border: 'none', color: '#888', cursor: 'pointer', fontSize: '16px' }}>×</button>
      </div>

      <h1 style={{ margin: '0 0 10px 0', fontSize: '22px', fontWeight: 'bold', color: '#4CAF50' }}>Yup, that's me, Yassine!</h1>
      <div style={{ fontSize: '13px', lineHeight: '1.6', color: '#eee' }}>
        You're wondering how I got here?<br></br>Even I am not sure how.<br></br>
